...
/** OpenAPI `info` object (title, version, contact, license). */
...
/** OpenAPI server entry (url + description). */
...
/** Options for the OpenAPI plugin (title, version, spec/docs paths, security). */
...
/** A full OpenAPI 3.0 document (generated by the plugin). */
...
/** One OpenAPI operation (parameters, request body, responses). */
...
/** OpenAPI response definition (content + headers). */
...
/** Per-route documentation metadata for OpenAPI generation. */
...
/** Builds an OpenAPI document from registered routes + TypeBox schemas. */
